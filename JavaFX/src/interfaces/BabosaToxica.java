...
public class BabosaToxica extends Enemigo {
    ...
    public BabosaToxica(double x, double y) {
        ...
        this.colorBase = Color.OLIVEDRAB;
        inicializarAnimacion();
        calcularFrame(0);
    }

    public void inicializarAnimacion() {
        Image img = Juego.imagenes.get("babosa");
        ...
        animacionMover = new Animacion(0.14, coordenadas);
    }
    ...
    public void pintar(GraphicsContext graficos) {
        if (Juego.imagenes.get(nombreImagen) != null) {
            ...
            graficos.setFill(Color.OLIVEDRAB);
    ...
    public Rectangle obtenerRectangulo() {
        return new Rectangle(x + 10, y + 10, 70, 45);
    }
}
